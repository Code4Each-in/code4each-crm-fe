        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7 wow fadeIn" data-wow-delay="0.3s">
                    <h4 class="text-primary mb-4 border-bottom border-2 d-inline-block p-2 title-border-radius ss_editable"
                    ...
                    <h1 class="text-dark mb-4 display-5 ss_editable"
                    ...
                    <p class="text-dark mb-4 ss_editable"
...
const componentId = 'COMP_SS_SALON_ABOUT2_87';
