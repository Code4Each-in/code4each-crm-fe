    ...
    <div class="container-fluid border-bottom bg-light wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
        ...
        <div class="container px-0">
            <nav class="navbar navbar-expand-xl py-3">
                <div
                  class="footer-logo m-b-20 ss_editable"
...
const componentId = 'COMP_SS_SALON_HEADER2_86';
...
<style scoped>
    ...
    .hero-header,
    .page-header {
        background: linear-gradient(rgba(0, 0, 0, 1.0), rgba(0, 0, 0, 0.05)), url('../images/salon-hero.jpg');
